\section{Some generalities on Lie algebras}
    ...
    \subsection{Perfect Lie algebras and their central extensions}
        ...
        \todo[inline]{Corrected lemma about extending bilinear forms to central extensions}
        ...
        \begin{lemma}[Extending invariant bilinear forms to central extensions] \label{lemma: extending_bilinear_forms_to_central_extensions}
            Let:
                $$0 \to \Omega \to \frake \xrightarrow[]{\pi} \a \to 0$$
            be a central extension of some Lie algebra $\a$, and assume that $\frake$ is perfect\footnote{... and hence $\a$ too is perfect.}. Then, there will be a bijection:
                $$
                    \begin{tikzcd}
                	{\left\{ \text{invariant symmetric bilinear forms $(-, -)_{\frake}$ on $\frake$ such that $\Rad(-, -)_{\frake} \supset \Omega$} \right\}} \\
        ...
        \end{lemma}
            \begin{proof}
                ...
                To begin, let us make sure that the given function $r$ between the two sets of bilinear forms is well-defined. To this end, suppose that $\frake$ carries an invariant and symmetric bilinear form $(-, -)_{\frake}$ such that $\Omega \subseteq \Rad(-, -)_{\frake}$. This means that:
