\section{Examples of \texorpdfstring{$\gamma$}{}-extended toroidal Lie algebras}
    \subsection{Some explicit toroidal \texorpdfstring{$2$}{}-cocycles; statement of the main theorem and a proof outline}
        ...
        \todo[inline]{Main theorem on $\sigma_1$ and $\sigma_2$.}
        Our main result concerning $\sigma_1$ and $\sigma_2$ is as follows:
    ...
    \subsection{\texorpdfstring{$\gamma$}{}-invariance}
        Since lemma \ref{lemma: yangian_div_zero_vector_fields_basic_properties}, we have known how the elements of the \say{standard} basis:
    ...
    \subsection{\textit{Interlude}: An appearance of the Virasoro algebra}
        ...
        \begin{corollary}[A Virasoro $2$-coboundary] \label{coro: a_virasoro_coboundary}
            Let:
        ...
        \begin{proposition}[Restricting $\sigma_1$ and $\sigma_2$ to the Witt algebra] \label{prop: billig_toroidal_cocycles_on_the_witt_algebra}
        ...
        \end{proposition}
            ...
            \end{proof}
        \begin{remark}[\say{The} Virasoro central element]
            Because we now know that:
                $$\sigma_i(D_{r, -1}, D_{a, -1}) = \delta_{r + a, 0} r^3 c_v$$
            it is clear that \say{the} Virasoro central element $c_{\frakv}$ is nothing but $c_v$.
        \end{remark}
    ...
    \subsection{Cohomological non-triviality}
        ...
        \todo[inline]{Moved lemma about the gradedness of $\tau_i$ to the appendix about Lie algebra cohomology (see lemma \ref{lemma: graded_2_coboundaries}), as I would like to keep this subsection as concise as possible. I also realised after I sent the email at 23:31 that I might have a slight improvement of the existing proof, which has been included.}
        ...
        \begin{remark}[Some recollection]
            ...
            \end{itemize}
        \end{remark}
        \begin{proposition}[$\sigma_1$ is not $2$-coboundary] \label{prop: cohomological_non_triviality_of_billig_toroidal_cocycles_explicit_formula}
