\section{Lie algebra cohomology}
    \subsection{A brief account of the generalities}
        ...
        Finally, let us investigate a particular property enjoyed by graded Lie $2$-coboundaries, namely that they admit \say{lifts} along the coboundary map $d_1$ which are \textit{graded} linear maps. This is a technical preparation in service of the proof of proposition \ref{prop: cohomological_non_triviality_of_billig_toroidal_cocycles_explicit_formula}.
        ...
        \end{remark}
        \todo[inline]{Re-proved graded coboundary lemma.}
